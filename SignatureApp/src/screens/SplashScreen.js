...
// On web, useNativeDriver MUST be false — SVG transforms are not supported by native driver in browsers
...
export function SplashScreen({ onFinish }) {
    ...
    // Global safety net — fires within 8s no matter what
    ...
    useEffect(() => {
        ...
        Animated.parallel([
            ...
            Animated.parallel([
                ...
                // Step 3: Halves come back and fade
                Animated.parallel([
                    ...
                    Animated.parallel([
                        ...
                        Animated.timing(subtitleOpacity, { toValue: 0.8, duration: 350, easing: Easing.out(Easing.cubic), useNativeDriver: ND })
                            .start(() => {
                                // Step 5: Fade intro → bean rain on ALL platforms
                                setTimeout(() => {
