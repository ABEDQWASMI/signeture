...
const styles = StyleSheet.create({
  ...
  logoOuter: {
    ...
    backgroundColor: 'rgba(197,163,109,0.08)',
    borderWidth: 1, borderColor: 'rgba(197,163,109,0.15)',
  ...
  eyebrowText: { color: '#C5A36D', fontSize: 10, letterSpacing: 2, fontWeight: '600' },
  headline: {
  ...
  cardOuter: {
    borderRadius: 28, backgroundColor: 'rgba(197,163,109,0.06)',
    borderWidth: 1, borderColor: 'rgba(197,163,109,0.12)',
    padding: 2, marginBottom: 24,
  },
  cardInner: {
    borderRadius: 26, backgroundColor: '#0F0D0A',
    padding: 20,
  ...
  forgotLink: { color: '#C5A36D', fontSize: 12 },
  ...
  browseBtn: {
    ...
    borderRadius: 14, borderWidth: 1, borderColor: 'rgba(197,163,109,0.15)',
    backgroundColor: 'rgba(197,163,109,0.05)',
  },
  browseBtnText: { color: '#C5A36D', fontSize: 13, fontWeight: '600' },
  ...
  footerLink: { color: '#C5A36D', fontSize: 14, fontWeight: '600' },
});